...
function bootstrap() {
    return __awaiter(this, void 0, void 0, function () {
        var app, usersService, adminEmail, adminName, adminPassword, existing, _a, _b;
        var _c;
        return __generator(this, function (_d) {
            switch (_d.label) {
                ...
                case 1:
                    ...
                    adminPassword = 'adm123';
                    return [4 /*yield*/, usersService.findByEmail(adminEmail)];
                case 2:
                    existing = _d.sent();
                    if (!!existing) return [3 /*break*/, 5];
                    _b = (_a = usersService['usersRepository']).save;
                    _c = {
                        email: adminEmail,
                        name: adminName
                    };
                ...
                case 3: return [4 /*yield*/, _b.apply(_a, [(_c.password = _d.sent(),
                            _c.role = user_entity_1.Role.ADMIN,
                            _c)])];
                case 4:
                    _d.sent();
