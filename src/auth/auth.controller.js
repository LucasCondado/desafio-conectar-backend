...
var AuthController = function () {
                    ...
                    switch (_a.label) {
                        case 0:
                            ...
                            if (!loginDto.email ||
                                ...
                                this.logger.warn("Tentativa de login com dados malformados: ".concat(JSON.stringify(loginDto)));
                                throw new common_1.BadRequestException('Dados de login inválidos.');
                            }
                            return [4 /*yield*/, this.authService.validateUser(loginDto.email, loginDto.password)];
                        case 1:
                            user = _a.sent();
                            if (!user) {
                                this.logger.warn("Login falhou para o email: ".concat(loginDto.email));
                                throw new common_1.UnauthorizedException('Credenciais inválidas');
                            }
                            this.logger.log("Login efetuado: ".concat(loginDto.email, " (id: ").concat(user.id, ")"));
    ...
    (function () {
        ...
        _login_decorators = [(0, swagger_1.ApiBody)({ type: login_dto_1.LoginDto }), (0, swagger_1.ApiOperation)({ summary: 'Realiza login e retorna o token JWT' }), (0, swagger_1.ApiResponse)({ status: 201, description: 'Login realizado com sucesso' }), (0, swagger_1.ApiResponse)({ status: 401, description: 'Credenciais inválidas' }), (0, common_1.Post)('login')];
