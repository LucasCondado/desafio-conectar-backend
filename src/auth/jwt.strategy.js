        ...
        JwtStrategy_1.prototype.validate = function (payload) {
            return __awaiter(this, void 0, void 0, function () {
                ...
                return __generator(this, function (_a) {
                    switch (_a.label) {
                        case 0:
                            this.logger.debug("Validando payload JWT: ".concat(JSON.stringify(payload)));
                            ...
                            if (payload.role !== 'admin' && payload.role !== 'user') {
                                this.logger.warn("Role inv\u00E1lido: ".concat(payload.role));
                                throw new common_1.UnauthorizedException('Role inválido.');
                            }
                            return [4 /*yield*/, this.usersService.findOne(payload.sub)];
                        case 1:
                            user = _a.sent();
                            if (!user) {
                                this.logger.warn("Usu\u00E1rio n\u00E3o encontrado: ".concat(payload.sub));
                                throw new common_1.UnauthorizedException('Usuário não encontrado pelo token.');
                            }
                            ...
                            // }
                            // Log de sucesso
                            this.logger.debug("Usu\u00E1rio autenticado: ".concat(user.email));
